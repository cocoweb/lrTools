...
import com.zxyg.modules.security.springsecurity.SpringSecurityUtils;
import com.zxyg.modules.utils.StrUtils;
...
public final class RequestUtil {
    ...
    public static Object getRequestParamValue(String param)
    {
        ...
        if (paramNames != null) {
            while (paramNames.hasMoreElements()) {
                ...
                if (paramName != null && paramName.equals(param)) {
                    paramValue = Struts2Utils.getRequest().getParameter(paramName);
                }
            }
        }
        return paramValue;
