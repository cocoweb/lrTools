...
public class lr extends I_lr {
    ...
    public static String eval_string(String paramString) {
        return ParamUtils.eval_string(paramString);
        		//.replaceVariables(paramString, ParameterCache.getInstance().getMapCache());
    }
    ...
    public static int save_string(String sValue, String ParaName) {
    	ParamUtils.save_string(sValue, ParaName);
        //ParameterCache.getInstance().put(eval_string(ParaName), eval_string(sValue));
        return 0;
    }
