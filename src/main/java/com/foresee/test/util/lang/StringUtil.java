...
public final class StringUtil {
	...
	public static String arrayIndex(String[] args, int _index) {
		return args[_index];
	}
	 ...
	 * @return  value值
	 */
	public static String parsarKVStrValue(String sSource){
	    String[] arrStr = split(sSource, "=:", 2);
	    if (arrStr.length>=2){
	        return arrStr[1];
	 ...
	 * @return  Key值
	 */
	public static String parsarKVStrKey(String sSource){
		return split(sSource, "=:", 2)[0];
	 ...
	 * K=key  V=Value
	 * @param sSource
	 * @return  String[]数组 0：key  1：Value
	 */
	public static String[] parsarKVStr(String sSource){
		return split(sSource, "=:", 2);
		
	}
	
	
    public static int findStringCount(String sSrc, String smatch) {
        int i = 0;
        int index = sSrc.indexOf(smatch, i);
        while (index >= 0 && index != -1) {
            i++;
            index = sSrc.indexOf(smatch, i);
        }
    ...
    public static String locateString(String sSrc,String LeftStr,String RightStr){
        int fromIndex = 0;
        int indexLeft=sSrc.indexOf(LeftStr);
        int indexRight = sSrc.indexOf(RightStr);
        
        
        if(isNotEmpty(LeftStr)&&sSrc.indexOf(LeftStr)>=0){
