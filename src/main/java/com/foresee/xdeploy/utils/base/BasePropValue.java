...
public abstract class BasePropValue {
    ...
    private  ExtProperties exprop = null;
 

    /**
     * @param xprop the xprop to set
     */
    public  void setExProp(ExtProperties xprop) {
        exprop = xprop;
    }
    ...
    public void loadPropFile(String path){
    	exprop = ExtPropertiesFactory.loadxProperties(path, exprop);
    }
    

    public  ExtProperties getExProp() {
        return exprop;
    }
	...
	public String toString() {
		return "BasePropValue [exprop=" + exprop + "]";
	}
